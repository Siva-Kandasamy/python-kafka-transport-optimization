...
class Station(Producer):
    ...
    #
    # Complete: Define this value schema in `schemas/station_value.json, then uncomment the below
    #
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        #topic_name = f"{cta_station_dtl}" # complete: Come up with a better topic name
        #topic_name = f"cta_station_dtl"
        topic_name = f"com.cta.station.arrival_dtl.tbl1"
        super().__init__(
            topic_name,
            key_schema=Station.key_schema,
            # complete: value_schema=Station.value_schema, # TODO: Uncomment once schema is defined
